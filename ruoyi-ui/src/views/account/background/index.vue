...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/account/background/importData"
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('account/background/importTemplate', {
      }, `background_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
